Contributing to BitCoin ONE Core
============================

The BitCoin ONE Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BitCoin ONE Core project, and is not to be
confused with overall BTCONE Network Protocol consensus changes.

Whether a pull request is merged into BitCoin ONE Core rests with the project merge
...
Patches that change BTCONE consensus rules are considerably more involved than
...
Where a patch set proposes to change the BTCONE consensus, it must have been
...
The project leader is the release manager for each BitCoin ONE Core release.
