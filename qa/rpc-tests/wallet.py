...
#   c) node1 mines 32 blocks, so now node 0 has 60001bitcoinone, node 1 has 4250bitcoinone, node2 has none.
#   d) node0 sends 601 bitcoinone to node2, in two transactions (301 bitcoinone, then 300 bitcoinone).
