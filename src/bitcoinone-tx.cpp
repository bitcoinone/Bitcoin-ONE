...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BitCoin ONE Core bitcoinone-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitcoinone-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinone transaction") + "\n" +
                               "  bitcoinone-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinone transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoinone transaction
