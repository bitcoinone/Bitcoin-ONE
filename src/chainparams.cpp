...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000000b0c3e5681cb85c90c29a57d829fbd866d5a22eb7b1d53b33eefe184b1a"));
    
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1570470104, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 31242;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // BTCONE starting difficulty is 1 / 2^12
        nMaxReorganizationDepth = 100;
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // BTCONE: 1 day
        nTargetSpacing = 1 * 60;  // BTCONE: 1 minute
        nMaturity = 20;
        ...
        const char* pszTimestamp = "2020 Could Be Deciding Year for Proof-of-Stake";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1570470104;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 810820;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000000b0c3e5681cb85c90c29a57d829fbd866d5a22eb7b1d53b33eefe184b1a"));
        assert(genesis.hashMerkleRoot == uint256("0x5c9935088214f96d2225e3d8f4bd40cc3655bc6a93ce61a843abb5c083b60c70"));

        vFixedSeeds.clear();
        vSeeds.push_back(CDNSSeedData("bitcoinone.io", "seed.bitcoinone.io")); // Primary DNS Seeder Nodes
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet bitcoinone addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet bitcoinone script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet bitcoinone BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet bitcoinone BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet bitcoinone BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // BTCONE: 1 day
        nTargetSpacing = 1 * 60;        // BTCONE: 1 minutes
