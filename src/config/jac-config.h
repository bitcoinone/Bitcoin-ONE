/* src/config/bitcoinone-config.h.  Generated from bitcoinone-config.h.in by configure.  */
/* src/config/bitcoinone-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "bitcoinone.org"
...
#define PACKAGE_TARNAME "bitcoinone"
