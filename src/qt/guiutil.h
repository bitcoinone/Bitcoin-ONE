...
/** Utility functions used by the BTCONE Qt UI.
 */
namespace GUIUtil
{
...
// Render BTCONE addresses in monospace font
...
// Parse "bitcoinone:" URI into recipient object, return true on successful parsing
