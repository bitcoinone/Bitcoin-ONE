...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BitCoin ONE Core"),
     ...
     * override -datadir in the bitcoinone.conf file in the default data directory
     * (to be consistent with bitcoinoned behavior)
     */
    if (dataDir != getDefaultDataDirectory())
