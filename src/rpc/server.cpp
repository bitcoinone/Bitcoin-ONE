...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BTCONE features */
        {"bitcoinone", "masternode", &masternode, true, true, false},
        {"bitcoinone", "listmasternodes", &listmasternodes, true, true, false},
        {"bitcoinone", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitcoinone", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitcoinone", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bitcoinone", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bitcoinone", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bitcoinone", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitcoinone", "masternodedebug", &masternodedebug, true, true, false},
        {"bitcoinone", "startmasternode", &startmasternode, true, true, false},
        {"bitcoinone", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitcoinone", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitcoinone", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitcoinone", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitcoinone", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitcoinone", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitcoinone", "mnsync", &mnsync, true, true, false},
        {"bitcoinone", "spork", &spork, true, true, false},
        {"bitcoinone", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> bitcoinone-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:31243/\n";
}
